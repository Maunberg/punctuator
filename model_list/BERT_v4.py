...
class model(pl.LightningModule):
    def __init__(self, pretrained_model_name="DeepPavlov/rubert-base-cased", freeze_bert=False):
        super().__init__()
    ...
    def training_step(self, batch, batch_idx):
        ...
        f1_pbr = f1_score(preds, labels, n=6)
        f1_qbr = f1_score(preds, labels, n=7)
        ...
        self.log('f1 .br', f1_pbr, prog_bar=True)
        self.log('f1 ?br', f1_qbr, prog_bar=True)
    ...
    def validation_step(self, batch, batch_idx):
        ...
        self.log('f1 Upper', f1_up, prog_bar=True)
        self.log('f1 ABBR', f1_ab, prog_bar=True)
        return {'f1 _':f1_sp, 'f1 .': f1_fs, 'f1 ,':f1_cm, 'f1 ?':f1_qe, 'f1 .br':f1_pbr, 'f1 ?br':f1_qbr, 
